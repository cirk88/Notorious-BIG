...
stargazer(df_corp, summary = TRUE)
...
As mentioned, defaulting firms are highly underrepresentated in the data set. We deal with this by implementing an undersamlpling technique with the MICE package.
